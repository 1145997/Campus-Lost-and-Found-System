...
('修改当前登录用户自己的失物或招领信息，修改后重新进入待审核', 'PUT', '/api/lostfound/{id}',
 '{\"type\":1,\"title\":\"重新修改后的校园卡寻物启事\",\"itemName\":\"校园卡\",\"categoryId\":6,\"brand\":\"\",\"color\":\"蓝色\",\"description\":\"我在第二教学楼附近丢失校园卡，如有拾到请联系。\",\"image\":\"http://example.com/campus-lost-found/demo/lostfound-image.png\",\"eventTime\":\"2026-04-02T08:30:00\",\"eventPlace\":\"第二教学楼门口\",\"contactName\":\"张三\",\"contactPhone\":\"13900000001\",\"contactWechat\":\"zhangsan123\"}',
